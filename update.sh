...
icons=(
    ...
    'icon-fixed-width/fa fa-fixed-width'
    ...
    'icon-unchecked/fa fa-unchecked'
...
do
    #echo ${icons[count]}
    find $1 \( -name "*.js" -o -name "*.twig"  -o -name "*.twigjs" -o -name "*.md" \) -type f -print0 | xargs -0 sed -i "s/${icons[count]}/g"
    count=$(( $count + 1 ))
done
